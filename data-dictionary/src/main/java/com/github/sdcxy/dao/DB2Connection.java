...
public class DB2Connection extends AbstractDataBaseConnectionFactory{
    ...
    private Connection getConnection(String ip, int port, String dataBaseName, String username, String password){
        ...
        try{
            Class.forName(DBDriver.DB2_DRIVER.getDriverName());
            ...
            throw new GlobalException(ExceptionEnum.DB2_CONNECTION_EXCEPTION.getCode(),ExceptionEnum.DB2_CONNECTION_EXCEPTION.getMsg());
        }
        return conn;
    }
